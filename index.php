<main>
        ...
        <div class="row">
          <div class="flip-stats-counter w-100 flipClock">
           ...
           <div class="counter flipUnitContainer" data-count="31">
            ...
            <div class="flipCard first unfold">
              <span>0</span>
            </div>
            <div class="flipCard second fold">
              <span>0</span>
            </div>
          </div>
 ...
 <br> Built</p>
  ...
  <div class="container-fluid" id="featured-projects">
    <div class="container">
      <h3 class=" text-head col-12"  data-aos="zoom-in-up"> <span> Featured </span> Projects </h3>
      </div>
           <div class="row">
           <div class="col-12">
  ...
  <!-- Green Solutions Starts Here -->
      ...
      <div class="container">
            <div class="row mb-4">
                    <div class="col-12">
                    <h3 class="text-head mb-3"><span>Green</span> Solution</h3>
      ...
      <div class="">
            ...
            <div class="row">
                <div class="col-lg-2 col-md-4 offset-lg-1 col-12 main-slider align-self-center">
                    ...
                    <div><h4><span>Green</span> <br> Solution</h4></div>
