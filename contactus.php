<main>
        <div class="container-fluid banner--header contact-banner">
            <div class="container">
                <div class="row">
                    <div class="col-12">
            ...
            <div class="container">
                ...
                <div class="row relative">
                    <div class=" col-sm-12 col-12 col-md-7 col-lg-7 mb-3 contact--content">
                        <ul>
                            <li class="aos-init" data-aos="fade-in" data-aos-easing="linear" data-aos-duration="1500">
                            ...
                            <li class="aos-init" data-aos="fade-in" data-aos-easing="linear" data-aos-duration="1800">
                                <div class="address-section">
                             ...
                             <li class="aos-init" data-aos="fade-in" data-aos-easing="linear" data-aos-duration="2100">
                                <div class="address-section">
                    ...
                    <div class="col-sm-12 col-12 col-md-5 col-lg-5 contact--form  aos-init" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="2100">
                        <h3>Get in Touch </h3>
